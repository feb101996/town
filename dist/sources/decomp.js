...
function Eval_decomp(p1) {
    ...
    var arg = eval_1.Eval(defs_1.cadr(p1));
    p1 = eval_1.Eval(defs_1.caddr(p1));
    var variable = p1 === defs_1.symbol(defs_1.NIL) ? guess_1.guess(arg) : p1;
    var result = decomp(false, arg, variable);
...
function decomp_sum(generalTransform, p1, p2) {
    ...
    p3 = defs_1.cdr(p1);
    var constantTerms = [...p3].filter((t) => !find_1.Find(t, p2));
